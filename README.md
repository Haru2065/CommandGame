# CommandGame
2Dのターン性コマンドバトルをUnityで制作しました。<br> 
このゲームではプレイヤーが戦略を練りつつ、敵を倒していくゲームです。
...
- お借りしたツール:UniTask,Newtonsoft.Json
...
<img width="1600" height="725" alt="image" src="https://github.com/user-attachments/assets/d1bac954-e38b-4e9f-a8b7-ec658ad88f19" /><br>

----------------------------------------------------------------------------------------------------------------------------------------

## 【敵キャラ紹介】
<img width="955" height="443" alt="image" src="https://github.com/user-attachments/assets/1b81031a-2cd1-4bc1-934a-db14ce8abc85" /><br>

<img width="955" height="443" alt="image" src="https://github.com/user-attachments/assets/3ffd9b0b-dd02-42af-8037-7db7bff60226" /><br>
